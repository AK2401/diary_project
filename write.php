...
<html lang="en">
  ...
  width: 77px  !important;
    ...
    <body>
      ...
      <p><input class="w3-input w3-padding-16 w3-border" type="datetime-local" placeholder="Date and time"  name="date" required></p>
      <p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Titale"  name="tital" required></p>
      <p> <textarea name="text" id="" cols="30" rows="10" placeholder="Write your Diary"  ></textarea></p>
...
if(isset($_POST['submit']))
{
    ...
    $query="INSERT INTO content VALUES('','$date','$tital','$text','$id')";

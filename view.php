...
<html lang="en">
    ...
    <body >
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('bookpic.jpg')" style="background-size: center"  >
 ...
 $data = mysqli_query($conn , "SELECT * FROM content WHERE userid='$userid' ");
...
?>
            ...
            <div class="col-12 col-sm-6 col-md-4 my-3 ">
               ...
               <td><?php echo $key['date']; ?></td><br>
                <td><?php echo $key['tital']; ?></td><br>
                <td><?php echo substr ($key['text'],0,40).'...';$key['text'];?></td><br>
                
                <a href="read.php?id=<?php echo $key['id']; ?>" class="btn-sm text-white btn btn-warning">Read</a>
